    ...
    <div className="fixed inset-0 -z-10">
      <div className="absolute inset-0 bg-[#0a0a0a]">
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute -top-1/4 -right-1/4 w-96 h-96 bg-[#00ffd5] rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000" />
